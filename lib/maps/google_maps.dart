    ...
    setState(() {
      _markers.add(
        Marker(
            ...
            position: LatLng(Maps_data.maps_list[index].lat1,Maps_data.maps_list[index].long1),
            icon:mapMarker,
      ...
      _markers.add(
          Marker(
              ...
              position: LatLng(Maps_data.maps_list[index].lat2,Maps_data.maps_list[index].long2),
              icon:mapMarker,
              infoWindow: InfoWindow(
      ...
      _markers.add(
          Marker(
              ...
              position: LatLng(Maps_data.maps_list[index].lat3,Maps_data.maps_list[index].long3),
              icon:mapMarker,
              infoWindow: InfoWindow(
      ...
      _markers.add(
          Marker(
              ...
              position: LatLng(Maps_data.maps_list[index].lat4,Maps_data.maps_list[index].long4),
              icon:mapMarker,
              infoWindow: InfoWindow(
      ...
      body: Center(
        child: GoogleMap(
          ...
          initialCameraPosition: CameraPosition(
            target:LatLng(Maps_data.maps_list[index].lat,Maps_data.maps_list[index].long),
            zoom:11,
        ),
        )
      ),
