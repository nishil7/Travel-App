...
import 'package:travel_app/toast_message.dart';
import 'package:travel_app/weather/networking.dart';
import 'package:travel_app/currency/currency_name.dart';
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            ...
                            if (double.parse(value) < 0) {
                              ToastMessage("Invalid Input").showMessage();
                              setState(() {
                                result = '';
                                value = '0';
                                textfield.clear();
